...
export class Backend implements backendInterface {
    ...
    async getAllRegistrations(arg0: string): Promise<Array<Registration> | null> {
...
function from_candid_opt_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_Registration>]): Array<Registration> | null {
